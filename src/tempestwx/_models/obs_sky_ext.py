...
class SkyDailyObservation(Model):
    ...
    precipitation_analysis_type: Optional[int] = None
    local_day_precipitation_minutes: Numeric = None
    wind_sample_interval: Numeric = None
    precipitation_type: Optional[int] = None
    ...
    def from_array(cls, array: list[Raw]) -> "SkyDailyObservation":
        ...
        return cls(  # type: ignore[arg-type]
            ...
            precipitation_analysis_type=padded[18],
            local_day_precipitation_minutes=padded[19],
            wind_sample_interval=padded[20],
            precipitation_type=padded[21],
            local_day_nearcast_precipitation_minutes=(array[22] if len(array) > 22 else None),
        )
